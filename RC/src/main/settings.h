...
#define BATTERY_CELL_ALERT_VOLTAGE_BYTE 7
#define BATTERY_CELL_CRITICAL_VOLTAGE_BYTE 8
...
#define DEFAULT_BATTERY_CELL_ALERT_VOLTAGE_BYTE RemoteBattery::toByte(BATTERY_CELL_ALERT_VOLTAGE)
#define DEFAULT_BATTERY_CELL_CRITICAL_VOLTAGE_BYTE RemoteBattery::toByte(BATTERY_CELL_CRITICAL_VOLTAGE)
