...
\begin{DoxyCompactList}\small\item\em Represents the Lipo battery pack and implements methods to get its charge level. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Macros}
\begin{DoxyCompactItemize}
\item 
