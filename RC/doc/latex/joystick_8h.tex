...
\begin{DoxyCompactList}\small\item\em \hyperlink{class_joystick}{Joystick} class is responsible for reading joystick inputs on both axis and embedded switch. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Macros}
\begin{DoxyCompactItemize}
\item 
